...
describe('SecurityService', () => {
  ...
  // NOTA: verifyAdminApiKey fue removido - ahora se usa Azure Function Keys (authLevel: "function")
  // La autenticación se maneja nativamente por Azure antes de que el código se ejecute
